...
def create_SECT_list(data_path):
    ...
    data_list = os.path.join(os.getcwd(),data_path + '120kv/')
    data_list = os.listdir(data_list)

    list_all = [{'data': os.path.join(data_path + '120kv/', path), 'label': os.path.join(data_path + '120kv/', path)} for path in data_list]
...
def create_list(data_path):
    ...
    data_list = os.path.join(os.getcwd(),data_path + '3T/')
    data_list = os.listdir(data_list)


    list_all = [{'data': os.path.join(data_path + 'std_dose/', path), 'label': os.path.join(data_path + 'std_dose/', path)} for path in data_list]
